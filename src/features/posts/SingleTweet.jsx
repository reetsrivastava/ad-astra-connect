		...
		<div className='flex w-full items-start justify-center container'>
			...
			{status.LOAD_CURRENT_TWEET === statusEnum['SUCCESS'] ? (
				<div className='text-left w-full md:w-4/6 md:ml-10'>
					...
					<h2 className='text-2xl font-semibold  border-b py-2 capitalize text-white bg-green-400 p-2'>
						Tweet
					</h2>
					<div className='py-4 border-b'>
						<div className='flex items-center justify-start text-left'>
							<NavLink to={`/`}>
								<div className='p-2 text-white bg-yellow-400 rounded m-2'>
									{userId.firstName[0]}
									{userId.lastName[0]}
								</div>
							</NavLink>
							<div className='flex justify-between w-full'>
								<div>
									<NavLink to={`/${userId.userName}`}>
										<h3 className='text-gray-500 font-semibold text-lg capitalize md:hover:underline text-yellow-700'>
											{userId.firstName} {userId.lastName}
										</h3>
									</NavLink>
									<NavLink to={`/${userId.userName}`}>
										<h3 className='text-green-400 text-md md:hover:underline'>
											{userId.userName}
										</h3>
									</NavLink>
								</div>
					...
					<div>
						<div className='border-b py-3 capitalize'>
							...
							<span className='text-green-400'>Reactions</span>
						</div>
					</div>
					<ReactionButtons
