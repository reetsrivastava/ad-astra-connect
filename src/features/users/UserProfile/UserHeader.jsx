...
export const UserHeader = ({ user, userTweets }) => {
	...
	return (
		<>
			...
			{editProfile && (
				<div className='inset-0  bg-green-200 opacity-50 fixed z-20'></div>
			)}
			<div className='border-b'>
				<div className='my-4 flex justify-between'>
					<div className='p-2 bg-green-200 text-green-700 border-green-200'>
					...
					{user._id !== currentUser._id ? (
						...
						<button
							className='self-center bg-yellow-400 text-white p-2 border-0 rounded'
				...
				<div className='text-left'>
					<h2 className='text-2xl font-semibold text-left capitalize text-green-900'>
						{user.firstName} {user.lastName}
					</h2>
					<div className='text-green-400 block lowercase'>@{user.userName}</div>
